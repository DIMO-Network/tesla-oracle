...
func (UnimplementedTeslaOracleServer) RegisterNewSyntheticDeviceV2(context.Context, *RegisterNewSyntheticDeviceV2Request) (*RegisterNewSyntheticDeviceV2Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterNewSyntheticDeviceV2 not implemented")
}
...
func (UnimplementedTeslaOracleServer) GetVinByTokenId(context.Context, *GetVinByTokenIdRequest) (*GetVinByTokenIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetVinByTokenId not implemented")
}
