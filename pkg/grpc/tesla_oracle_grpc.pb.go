...
func (c *teslaOracleClient) RegisterNewSyntheticDeviceV2(ctx context.Context, in *RegisterNewSyntheticDeviceV2Request, opts ...grpc.CallOption) (*RegisterNewSyntheticDeviceV2Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterNewSyntheticDeviceV2Response)
	err := c.cc.Invoke(ctx, TeslaOracle_RegisterNewSyntheticDeviceV2_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *teslaOracleClient) GetVinByTokenId(ctx context.Context, in *GetVinByTokenIdRequest, opts ...grpc.CallOption) (*GetVinByTokenIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetVinByTokenIdResponse)
	err := c.cc.Invoke(ctx, TeslaOracle_GetVinByTokenId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *teslaOracleClient) GetFleetTelemetryConfigByTokenId(ctx context.Context, in *GetFleetTelemetryConfigByTokenIdRequest, opts ...grpc.CallOption) (*GetFleetTelemetryConfigByTokenIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetFleetTelemetryConfigByTokenIdResponse)
	err := c.cc.Invoke(ctx, TeslaOracle_GetFleetTelemetryConfigByTokenId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTeslaOracleServer) RegisterNewSyntheticDevice(context.Context, *RegisterNewSyntheticDeviceRequest) (*RegisterNewSyntheticDeviceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterNewSyntheticDevice not implemented")
}
func (UnimplementedTeslaOracleServer) RegisterNewSyntheticDeviceV2(context.Context, *RegisterNewSyntheticDeviceV2Request) (*RegisterNewSyntheticDeviceV2Response, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterNewSyntheticDeviceV2 not implemented")
}
func (UnimplementedTeslaOracleServer) GetSyntheticDevicesByVIN(context.Context, *GetSyntheticDevicesByVINRequest) (*GetSyntheticDevicesByVINResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSyntheticDevicesByVIN not implemented")
}
...
func RegisterTeslaOracleServer(s grpc.ServiceRegistrar, srv TeslaOracleServer) {
	// If the following call panics, it indicates UnimplementedTeslaOracleServer was
...
func _TeslaOracle_RegisterNewSyntheticDeviceV2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterNewSyntheticDeviceV2Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TeslaOracleServer).RegisterNewSyntheticDeviceV2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TeslaOracle_RegisterNewSyntheticDeviceV2_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TeslaOracleServer).RegisterNewSyntheticDeviceV2(ctx, req.(*RegisterNewSyntheticDeviceV2Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TeslaOracle_GetVinByTokenId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetVinByTokenIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TeslaOracleServer).GetVinByTokenId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TeslaOracle_GetVinByTokenId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TeslaOracleServer).GetVinByTokenId(ctx, req.(*GetVinByTokenIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TeslaOracle_GetFleetTelemetryConfigByTokenId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFleetTelemetryConfigByTokenIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TeslaOracleServer).GetFleetTelemetryConfigByTokenId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TeslaOracle_GetFleetTelemetryConfigByTokenId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TeslaOracleServer).GetFleetTelemetryConfigByTokenId(ctx, req.(*GetFleetTelemetryConfigByTokenIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TeslaOracle_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RegisterNewSyntheticDeviceV2",
			Handler:    _TeslaOracle_RegisterNewSyntheticDeviceV2_Handler,
		},
		{
