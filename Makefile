...
docker: deps
	@docker build -f ./resources/docker/Dockerfile . -t dimozone/tesla-oracle:$(VER_CUT)
	@docker tag dimozone/tesla-oracle:$(VER_CUT) dimozone/tesla-oracle:latest

docker-cgo: deps
	@docker build -f ./resources/docker/Dockerfile.cgo . -t dimozone/tesla-oracle:$(VER_CUT)-cgo
	@docker tag dimozone/tesla-oracle:$(VER_CUT)-cgo dimozone/tesla-oracle:latest-cgo
...
generate-swagger: ## generate swagger documentation
	@swag -version
	swag init -g cmd/tesla-oracle/main.go --parseDependency --parseInternal